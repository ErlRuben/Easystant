...
## Core Problems
1. Problem 1: Communication Friction
    Rewriting messages manually is time-consuming
    Switching to external AI tools interrupts workflow
    Client or boss messages are often unclear

2. Problem 2: Task Creation
    - Difficult to extract clear tasks from unstructured messages
    - Creating meaningful task titles and descriptions takes time
    - Results are often too generic

3. Problem 3: No History / Lost Outputs
